...
(function () {
  ...
  var COLLECTION_SEO = {
    ...
    rings: ['טבעות - VerSans', 'קולקציית הטבעות של VerSans - טבעות כסף וזהב במגוון עיצובים ומידות.'],
    ...
    'watches-men': ['שעונים לגברים - VerSans', 'שעונים לגברים מבית VerSans במגוון דגמים, צבעים וסגנונות.'],
    'watches-women': ['שעונים לנשים - VerSans', 'שעונים לנשים מבית VerSans במגוון דגמים, צבעים וסגנונות.'],
